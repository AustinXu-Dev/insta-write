...
<html>
	<head>
		...
		<!-- Site favicon -->
		<link rel="apple-touch-icon" sizes="180x180" href="/images/site/{{ isset(settings()->site_favicon) ? settings()->site_favicon : ''}}?v={{ time() }}">
		<link 
			rel="icon" 
			type="image/png" 
			sizes="32x32" 
			href="/images/site/{{ isset(settings()->site_favicon) ? settings()->site_favicon : ''}}?v={{ time() }}"
		/>
	...
	<body>
		...
		<script src="/back/vendors/scripts/bootstrap-select.min.js"></script>
		<script>
